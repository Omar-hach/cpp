...
/*   Updated: 2023/12/26 10:32:53 by ohachami         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap( void ){
	...
	std::cout << "ClapTrap " << this->Name << " energy "<< this->Energy_points << " hit " << this->Hit_points << " damege " << this->Attack_damage << std::endl;
}
